            ...
            <form onSubmit={handleAddAssignment}>
              <div className="relative p-6 flex-auto">
                ...
                <div className="flex flex-col gap-1 mb-1">
                  ...
                  <input onChange={(e) => setInput({ ...input, title: e.target.value })} value={input.title} id="assignment" type="text" name="title" className="border bg-slate-700 border-black p-2 text-white" placeholder="Ex: https://github.com/learning-portal-lws" required />
                </div>
                ...
                <div className="column-xs">
                  ...
                  <div className="flex flex-col gap-1 flex-grow">
                    ...
                    <select
                      ...
                      name="video"
                      id="video_title"
                      className="border bg-slate-700 border-black p-2 text-white"
                    >
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <input onChange={(e) => setInput({ ...input, totalMark: e.target.value })} value={input.totalMark} id="duration" type="number" name="duration" className="border bg-slate-700 border-black p-2 text-white" placeholder="Ex: 44.26" required />
                  </div>
                </div>
              </div>
              {/* buttons */}
